...
public class TypeDAO {
    ...
    public static String sqlInitDB = "INSERT INTO " + TABLE_NAME + "(" + id_type + "," + nom_type + "," + description + "," + fk_categorie + ") VALUES (1,\"Soda\",\"soda\",1 )" +
            "(2,\"Jeux de societe\",\"jeu de societe\",2 );";
